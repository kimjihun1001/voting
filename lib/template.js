module.exports = {
    home_html: function() {
        ...
        <body>
            <div class="container">
                <h1>NA DAO</h1>
                <image src="https://drive.google.com/file/d/1hDcXSl_ROH0Vkn1irNEeNfvKNx9-0KdE/view?usp=sharing"></image>
                <h2>Welcome!</h2>
                <h2>Log in to join the NA DAO</h2>
                <form action="login" method="post" style="height:80px;">
                    <div class="w-50 me-3" style="float:left;">
